...
CANCER_RECOMMENDATIONS: dict[str, dict[str, Any]] = {
    "COAD": {
        ...
        "recommended": ["tcga", "geo", "string", "drugbank", "pubchem", "chembl"],
    ...
    "BRCA": {
        "label": "Breast Cancer",
        "recommended": ["tcga", "geo", "cptac", "string", "drugbank", "pubchem", "chembl"],
    ...
    "LUSC": {
        ...
        "recommended": ["tcga", "geo", "string", "drugbank", "pubchem"],
    ...
    "GBM": {
        "label": "Glioblastoma",
        "recommended": ["tcga", "geo", "scrna", "string", "drugbank", "pubchem", "chembl"],
    ...
    "OTHER": {
        ...
        "recommended": ["string", "drugbank", "pubchem", "chembl"],
        "tcga_projects": [],
        "geo_accessions": [],
